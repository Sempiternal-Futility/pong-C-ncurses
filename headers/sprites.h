...
void ball_move(int *posY, int *posX, int *posYbarleft, int *posYbarright, int *player_lost, short height, short dir); // Makes the ball move (last arg is the direction)
